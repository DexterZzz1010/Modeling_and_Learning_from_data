...
class RFClassifier:
    ...
    def train(self):
        ...
        clf2 = RandomForestClassifier(n_estimators=100, oob_score=True, random_state=1234)
    ...
    def visualize_results(self):
        ...
        test_labels = self.eclf_model.predict(self.feature_data)
        ...
        plt.title(f'Voting Classification ')
